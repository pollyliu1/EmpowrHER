      ...
      <div className="bg-[url('../../public/jumbotron-gradient.png')] bg-cover h-full">
        ...
        <div className="justify-content h-screen">
            ...
            <div className="max-w-screen-lg bg-white shadow-2xl rounded-3xl mx-auto text-center py-12 mt-20 mb-100">
              ...
              <div className="mt-8 flex justify-center">
                <div className="inline-flex rounded-md bg-blue-500 shadow rounded-3xl">
                  {user ? <> {user.displayName} </> : <SignInButton1 />}
                </div>
              </div>
            </div>
          </section>

          <section style={{ padding: 500 }}>
            <div>
              <Image
                src={separator}
                alt="separator bar"
          ...
          <section style={{ padding: 100 }}>
            <div className="max-w-2xl bg-indigo-200 shadow-2xl rounded-3xl mx-auto py-10 px-10 md:w-full">
              <p>
                "
